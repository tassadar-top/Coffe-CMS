...
<head>
    ...
    <title><?= \App\Core\Security::escape($profile['name'] ?? 'Beauty Soft'); ?></title>
    <link rel="stylesheet" href="<?= asset_url('css/app.css'); ?>">
    <link rel="stylesheet" href="<?= theme_asset_url('theme.css'); ?>">
</head>
<body class="theme-shell beauty-soft">
    ...
    <div class="container theme-nav">
        <a class="theme-brand theme-branding" href="<?= base_url(); ?>">
            ...
            <span class="theme-brand-copy">
                <span><?= \App\Core\Security::escape((string) ($branding['business_name'] ?? 'Beauty Soft')); ?></span>
